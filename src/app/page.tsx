...
import book from "./component/page";
...
// Define the async functions to handle API calls
const addBook = async (book: Book) => {
  const response = await fetch('/api/users', {
    method: 'POST',
    headers: {
...
// Main component that renders the button and the book component
// export default function Home() {
//   const [showBookComponent, setShowBookComponent] = useState(false);

//   const handleButtonClick = () => {
//     setShowBookComponent(true);
//   };

//   return (
//     <div className="flex flex-col items-center">
//       <button onClick={handleButtonClick} className="p-4 m-20 border rounded bg-green-700 hover:bg-red-600"
//       disabled={showBookComponent}>
//         Click
//       </button>
//       {showBookComponent && <BookComponent />}
//     </div>
//   );
// }
